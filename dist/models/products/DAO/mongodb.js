...
var ProductDAOMONGO = /** @class */ (function () {
    function ProductDAOMONGO(local) {
        ...
        this.products = (0, mongoose_1.model)('finalproductos', productsSchema);
    }
    ProductDAOMONGO.prototype.get = function (id) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.products.findById(id)];
                    case 1:
                        singleProduct = _a.sent();
                        singleProduct && outputGet.push(singleProduct);
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.products.find()];
                    case 3:
                        outputGet = _a.sent();
                        _a.label = 4;
    ...
    ProductDAOMONGO.prototype.add = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var newProduct;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newProduct = new this.products(data);
    ...
    ProductDAOMONGO.prototype.update = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        outputUpdate = [];
                        return [4 /*yield*/, this.products.findByIdAndUpdate(id, { $set: data }, { runValidators: true })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.products.findById(id)];
                    case 2:
    ...
    ProductDAOMONGO.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        outputDelete = [];
                        return [4 /*yield*/, this.products.findByIdAndDelete(id)];
                    case 1:
    ...
    ProductDAOMONGO.prototype.query = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var query;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.products.find(query)];
