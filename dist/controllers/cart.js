...
var cartapi_1 = require("../apis/cartapi");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, cartapi_1.cartAPI.getProducts(id_producto)];
                    case 1:
                    ...
                    case 2: return [4 /*yield*/, cartapi_1.cartAPI.getProducts()];
                    case 3:
                        get = _a.sent();
                        if (get.length === 0) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        id_producto = req.params.id_producto;
                        if (!id_producto) return [3 /*break*/, 2];
                        return [4 /*yield*/, cartapi_1.cartAPI.addProduct(id_producto)];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id_producto = req.params.id_producto;
                        return [4 /*yield*/, cartapi_1.cartAPI.deleteProduct(id_producto)];
                    case 1:
                        deletedProduct = _a.sent();
                        return [2 /*return*/, deletedProduct.length === 0
